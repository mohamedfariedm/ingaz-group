...
const FormPopup:React.FC<PopupProps> = ({ isOpen, onClose }: PopupProps) => {
  return (
    <AnimatePresence >
    {isOpen && (
      <motion.div
...
✖
          ...
          {/* Header */}
          <div className="text-center text-[#575757] text-3xl  bukra-semi-bold font-bold mb-6">
            نموذج تسجيل التوظيف
          </div>
          ...
          <div className="main-container w-full bg-[#191919] rounded-t-3xl p-8">
            <div className="flex flex-wrap justify-between gap-8">
              ...
              <div className="w-full flex flex-col">
                <label className="text-[#575757] text-sm text-start font-medium mb-2">
                  البريد الإلكتروني *
                </label>
                <input
                  type="email"
              ...
              <div className="w-full flex flex-col">
                ...
                <input
                  type="tel"
                  className="h-[56px] outline-none text-start  p-4 rounded-[1rem] bg-[#282828] text-white placeholder:text-[#575757]"
              ...
              <div className="w-full flex flex-col">
                ...
                <textarea
                  className="h-[163px] outline-none text-start p-4 rounded-[1rem] bg-[#282828] text-white placeholder:text-[#575757]"
              ...
              <div className="w-full  flex justify-start mt-4">
                <button className="bg-[#15B86C] text-white px-6 py-3 rounded-[1rem] shadow-md hover:bg-green-600 transition w-[100%] md:w-[48%]">
                  إرسال
                </button>
              </div>
            </div>
